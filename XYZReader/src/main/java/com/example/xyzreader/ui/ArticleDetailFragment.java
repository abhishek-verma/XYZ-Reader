...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mTwoPane) {
            mRootView.findViewById(R.id.upButtonContainer).setVisibility(View.GONE);
        } else {
            mRootView.findViewById(R.id.upButtonContainer).setVisibility(View.VISIBLE);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        Log.d(LOG_TAG, "onCreateLoader: abhi i:" + i);
        return ArticleLoader.newInstanceForItemId(getActivity(), mItemId);
    }

    @Override
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        Log.d(LOG_TAG, "onLoadFinished abhi for mItemId:" + mItemId);
        if (!isAdded()) {
            if (cursor != null) {
                cursor.close();
            }
        ...
        if (mCursor != null && !mCursor.moveToFirst()) {
            Log.e(TAG, "abhi Error reading item detail cursor");
            mCursor.close();
            mCursor = null;
        }
